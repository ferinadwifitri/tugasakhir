  ...
  <div class="content-wrapper">
      ...
      <h1>
          Pembayaran ID. Transaksi = {{$transaksi->id_transaksi}}
          Member = {{$transaksi->member_id}}
      ...
      <body>
          ...
          <canvas style="margin-left: 10%"></canvas>
           ...
           <a href="/transaksiberjalan" class="btn btn-sm btn-warning" data-toggle="modal"><i class="fa fa-times"></i> Tutup Halaman Pembayaran</a>
